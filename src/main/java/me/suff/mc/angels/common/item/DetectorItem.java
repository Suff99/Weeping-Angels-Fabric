...
public class DetectorItem extends Item {
    ...
    public void inventoryTick(ItemStack stack, Level worldIn, Entity entityIn, int itemSlot, boolean isSelected) {
       ...
       /*     setTime(stack, getTime(stack) + 1);
            ...
            List< WeepingAngelEntity > angels = entityIn.level.getEntitiesOfClass(WeepingAngelEntity.class, entityIn.getBoundingBox().expand(15, 15, 15), LivingEntity::isAlive);
                ...
                if (!angels.isEmpty() && PlayerUtils.isInEitherHand((LivingEntity) entityIn, stack.getItem())) {
                    {
                        if (entityIn.age % 20 == 0) {
                            worldIn.playSound(null, entityIn.getX(), entityIn.getY(), entityIn.getZ(), WASounds.DING, SoundSource.PLAYERS, 0.2F, 1.0F);
                        }
